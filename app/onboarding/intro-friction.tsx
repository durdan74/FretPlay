...
export default function OnboardingIntroFrictionScreen() {
  return (
    <OnboardingMessageScreen
      ...
      description="Trop d'infos à penser en même temps, coordination des deux mains, notes qu'on cherche au lieu de les jouer. Résultat : on stagne sans comprendre pourquoi."
      onBack={() => router.back()}
